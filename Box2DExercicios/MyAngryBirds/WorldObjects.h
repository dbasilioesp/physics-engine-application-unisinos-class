...
b2Body *CreateWoodBarLarge(b2World *world, float posX, float posY, BodyUserData *userData = NULL);


b2Body *CreateRevolvingDoor(b2World *world, float posX, float posY, BodyUserData *userData = NULL);
